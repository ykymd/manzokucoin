...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Manzokucoin Core manzokucoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  manzokucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded manzokucoin transaction") + "\n" +
              "  manzokucoin-tx [options] -create [commands]   " + _("Create hex-encoded manzokucoin transaction") + "\n" +
              "\n";
