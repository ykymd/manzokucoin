...
#if defined(NDEBUG)
# error "Manzokucoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Manzokucoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("manzokucoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Manzokucoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Manzokucoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
