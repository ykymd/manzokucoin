...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("manzokucointools.com", "dnsseed.manzokucointools.com"));
        vSeeds.push_back(CDNSSeedData("manzokucoinpool.org", "dnsseed.manzokucoinpool.org"));
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.manzokucoin.loshan.co.uk"));
        ...
        // Manzokucoin: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("manzokucointools.com", "testnet-seed.manzokucointools.com"));
        ...
        // Manzokucoin: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // Manzokucoin: v2 enforced using Bitcoin's supermajority rule
