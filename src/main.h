...
static const CAmount DUST_THRESHOLD = 100000; // 0.001 MZK
/** Litecoin: Default TX Fee per 1000 bytes */
static const CAmount DEFAULT_TX_FEE = 100000; // 0.001 MZK

/** Litecoin: default minimum input threshold, override with -mininput */
static const CAmount DEFAULT_MINIMUM_INPUT_THRESHOLD = DUST_THRESHOLD / 100; // 0.00001 MZK
